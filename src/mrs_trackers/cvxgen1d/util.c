/* Produced by CVXGEN, 2018-02-09 07:26:24 -0500.  */
...
float randn_internal1d(long *idum, int reset) {
  ...
  if (iset==0) {
    do {
      v1 = 2.0*ran11d(idum, reset)-1.0;
      v2 = 2.0*ran11d(idum, reset)-1.0;
      rsq = v1*v1+v2*v2;
...
double randn1d(void) {
  return randn_internal1d(&global_seed, 0);
}
void reset_rand1d(void) {
  srand(15);
  global_seed = 1;
  randn_internal1d(&global_seed, 1);
}
