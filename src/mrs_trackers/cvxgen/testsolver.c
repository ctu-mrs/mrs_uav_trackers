/* Produced by CVXGEN, 2018-03-14 11:03:56 -0400.  */
...
void load_default_data(void) {
  ...
  params.x_max_2[0] = 0.09099461171173773;
  params.x_min_2[0] = -1.7774338357932473;
  params.x_min_3[0] = 0.9709490941985153;
  params.x_max_3[0] = 0.6093728658967841;
}
