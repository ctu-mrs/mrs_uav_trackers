/* Produced by CVXGEN, 2018-02-17 15:26:30 -0500.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (nrhs > 1) {
    /* Assume that the second argument is the settingsYaw. */
    if (mxGetField(prhs[1], 0, "eps") != NULL)
      settingsYaw.eps = *mxGetPr(mxGetField(prhs[1], 0, "eps"));
    if (mxGetField(prhs[1], 0, "max_iters") != NULL)
      settingsYaw.max_iters = *mxGetPr(mxGetField(prhs[1], 0, "max_iters"));
    if (mxGetField(prhs[1], 0, "refine_steps") != NULL)
      settingsYaw.refine_steps = *mxGetPr(mxGetField(prhs[1], 0, "refine_steps"));
    if (mxGetField(prhs[1], 0, "verbose") != NULL)
      settingsYaw.verbose = *mxGetPr(mxGetField(prhs[1], 0, "verbose"));
    if (mxGetField(prhs[1], 0, "better_start") != NULL)
      settingsYaw.better_start = *mxGetPr(mxGetField(prhs[1], 0, "better_start"));
    if (mxGetField(prhs[1], 0, "verbose_refinement") != NULL)
      settingsYaw.verbose_refinement = *mxGetPr(mxGetField(prhs[1], 0,
            "verbose_refinement"));
    if (mxGetField(prhs[1], 0, "debug") != NULL)
      settingsYaw.debug = *mxGetPr(mxGetField(prhs[1], 0, "debug"));
    if (mxGetField(prhs[1], 0, "kkt_reg") != NULL)
      settingsYaw.kkt_reg = *mxGetPr(mxGetField(prhs[1], 0, "kkt_reg"));
    if (mxGetField(prhs[1], 0, "s_init") != NULL)
      settingsYaw.s_init = *mxGetPr(mxGetField(prhs[1], 0, "s_init"));
    if (mxGetField(prhs[1], 0, "z_init") != NULL)
      settingsYaw.z_init = *mxGetPr(mxGetField(prhs[1], 0, "z_init"));
    if (mxGetField(prhs[1], 0, "resid_tol") != NULL)
      settingsYaw.resid_tol = *mxGetPr(mxGetField(prhs[1], 0, "resid_tol"));
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.A.\n");
  } else {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.Af.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 3))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.B.\n");
  } else {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.Bf.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.Q.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 3))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.R.\n");
  } else {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_0.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_max_2.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_max_3.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_1 or paramsYaw.x_ss{1}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_2 or paramsYaw.x_ss{2}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_3 or paramsYaw.x_ss{3}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_4 or paramsYaw.x_ss{4}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_5 or paramsYaw.x_ss{5}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_6 or paramsYaw.x_ss{6}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_7 or paramsYaw.x_ss{7}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_8 or paramsYaw.x_ss{8}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_9 or paramsYaw.x_ss{9}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_10 or paramsYaw.x_ss{10}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_11 or paramsYaw.x_ss{11}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_12 or paramsYaw.x_ss{12}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_13 or paramsYaw.x_ss{13}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_14 or paramsYaw.x_ss{14}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_15 or paramsYaw.x_ss{15}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_16 or paramsYaw.x_ss{16}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_17 or paramsYaw.x_ss{17}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_18 or paramsYaw.x_ss{18}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_19 or paramsYaw.x_ss{19}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_20 or paramsYaw.x_ss{20}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_21 or paramsYaw.x_ss{21}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_22 or paramsYaw.x_ss{22}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_23 or paramsYaw.x_ss{23}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_24 or paramsYaw.x_ss{24}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_25 or paramsYaw.x_ss{25}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_26 or paramsYaw.x_ss{26}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_27 or paramsYaw.x_ss{27}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_28 or paramsYaw.x_ss{28}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_29 or paramsYaw.x_ss{29}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_30 or paramsYaw.x_ss{30}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_31 or paramsYaw.x_ss{31}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_32 or paramsYaw.x_ss{32}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_33 or paramsYaw.x_ss{33}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_34 or paramsYaw.x_ss{34}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_35 or paramsYaw.x_ss{35}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_36 or paramsYaw.x_ss{36}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_37 or paramsYaw.x_ss{37}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_38 or paramsYaw.x_ss{38}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_39 or paramsYaw.x_ss{39}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsYaw.x_ss_40 or paramsYaw.x_ss{40}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (prepare_for_c) {
    printf("settingsYaw.prepare_for_c == 1. thus, outputting for C.\n");
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_1[%d] = %.6g;\n", i, paramsYaw.x_ss_1[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.Q[%d] = %.6g;\n", i, paramsYaw.Q[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_2[%d] = %.6g;\n", i, paramsYaw.x_ss_2[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_3[%d] = %.6g;\n", i, paramsYaw.x_ss_3[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_4[%d] = %.6g;\n", i, paramsYaw.x_ss_4[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_5[%d] = %.6g;\n", i, paramsYaw.x_ss_5[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_6[%d] = %.6g;\n", i, paramsYaw.x_ss_6[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_7[%d] = %.6g;\n", i, paramsYaw.x_ss_7[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_8[%d] = %.6g;\n", i, paramsYaw.x_ss_8[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_9[%d] = %.6g;\n", i, paramsYaw.x_ss_9[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_10[%d] = %.6g;\n", i, paramsYaw.x_ss_10[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_11[%d] = %.6g;\n", i, paramsYaw.x_ss_11[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_12[%d] = %.6g;\n", i, paramsYaw.x_ss_12[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_13[%d] = %.6g;\n", i, paramsYaw.x_ss_13[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_14[%d] = %.6g;\n", i, paramsYaw.x_ss_14[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_15[%d] = %.6g;\n", i, paramsYaw.x_ss_15[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_16[%d] = %.6g;\n", i, paramsYaw.x_ss_16[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_17[%d] = %.6g;\n", i, paramsYaw.x_ss_17[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_18[%d] = %.6g;\n", i, paramsYaw.x_ss_18[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_19[%d] = %.6g;\n", i, paramsYaw.x_ss_19[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_20[%d] = %.6g;\n", i, paramsYaw.x_ss_20[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_21[%d] = %.6g;\n", i, paramsYaw.x_ss_21[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_22[%d] = %.6g;\n", i, paramsYaw.x_ss_22[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_23[%d] = %.6g;\n", i, paramsYaw.x_ss_23[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_24[%d] = %.6g;\n", i, paramsYaw.x_ss_24[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_25[%d] = %.6g;\n", i, paramsYaw.x_ss_25[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_26[%d] = %.6g;\n", i, paramsYaw.x_ss_26[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_27[%d] = %.6g;\n", i, paramsYaw.x_ss_27[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_28[%d] = %.6g;\n", i, paramsYaw.x_ss_28[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_29[%d] = %.6g;\n", i, paramsYaw.x_ss_29[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_30[%d] = %.6g;\n", i, paramsYaw.x_ss_30[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_31[%d] = %.6g;\n", i, paramsYaw.x_ss_31[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_32[%d] = %.6g;\n", i, paramsYaw.x_ss_32[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_33[%d] = %.6g;\n", i, paramsYaw.x_ss_33[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_34[%d] = %.6g;\n", i, paramsYaw.x_ss_34[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_35[%d] = %.6g;\n", i, paramsYaw.x_ss_35[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_36[%d] = %.6g;\n", i, paramsYaw.x_ss_36[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_37[%d] = %.6g;\n", i, paramsYaw.x_ss_37[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_38[%d] = %.6g;\n", i, paramsYaw.x_ss_38[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_39[%d] = %.6g;\n", i, paramsYaw.x_ss_39[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_ss_40[%d] = %.6g;\n", i, paramsYaw.x_ss_40[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsYaw.R[%d] = %.6g;\n", i, paramsYaw.R[i]);
    for (i = 0; i < 5; i++)
      printf("  paramsYaw.Af[%d] = %.6g;\n", i, paramsYaw.Af[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsYaw.x_0[%d] = %.6g;\n", i, paramsYaw.x_0[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsYaw.Bf[%d] = %.6g;\n", i, paramsYaw.Bf[i]);
    for (i = 0; i < 5; i++)
      printf("  paramsYaw.A[%d] = %.6g;\n", i, paramsYaw.A[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsYaw.B[%d] = %.6g;\n", i, paramsYaw.B[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsYaw.x_max_2[%d] = %.6g;\n", i, paramsYaw.x_max_2[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsYaw.x_max_3[%d] = %.6g;\n", i, paramsYaw.x_max_3[i]);
  }
  /* Perform the actual solve in here. */
  steps = solve_yaw();
  /* For profiling purposes, allow extra silent solves if desired. */
  settingsYaw.verbose = 0;
  ...
  *mxGetPr(xm) = workYaw.optval;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "gap", xm);
  *mxGetPr(xm) = workYaw.gap;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "steps", xm);
  *mxGetPr(xm) = steps;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "converged", xm);
  *mxGetPr(xm) = workYaw.converged;
