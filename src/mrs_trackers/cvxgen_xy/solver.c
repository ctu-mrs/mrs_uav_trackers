/* Produced by CVXGEN, 2018-01-06 07:23:02 -0500.  */
...
void setup_pointers(void) {
  ...
  vars.x_8 = work.x + 124;
  vars.x_9 = work.x + 130;
  vars.x_10 = work.x + 136;
  vars.x_11 = work.x + 142;
  vars.x_12 = work.x + 148;
  vars.x_13 = work.x + 154;
  vars.x_14 = work.x + 160;
  vars.x_15 = work.x + 166;
  vars.x_16 = work.x + 172;
  vars.x_17 = work.x + 178;
  vars.x_18 = work.x + 184;
  vars.x_19 = work.x + 190;
  vars.x_20 = work.x + 196;
  vars.x_21 = work.x + 202;
  vars.x_22 = work.x + 208;
  vars.x_23 = work.x + 214;
  vars.x_24 = work.x + 220;
  vars.x_25 = work.x + 226;
  vars.x_26 = work.x + 232;
  vars.x_27 = work.x + 238;
  vars.x_28 = work.x + 244;
  vars.x_29 = work.x + 250;
  vars.x_30 = work.x + 256;
  vars.x_31 = work.x + 262;
  vars.x_32 = work.x + 268;
  vars.x_33 = work.x + 274;
  vars.x_34 = work.x + 280;
  vars.x_35 = work.x + 286;
  vars.x_36 = work.x + 292;
  vars.x_37 = work.x + 298;
  vars.x_38 = work.x + 304;
  vars.x_39 = work.x + 310;
  vars.x_40 = work.x + 316;
}
...
long solveR(void) {
printf("x %f y %f z %f ", params.x_0[0],params.x_0[1],params.x_0[2]);
...
#ifndef ZERO_LIBRARY_MODE
  if (settings.verbose)
    printf("iterations     objv        gap       |Ax-b|    |Gx+s-h|    step\n");
#endif
  fillq();
  fillh();
  fillb();
