...
void CvxWrapper::setLimits(VectorXd& max_speed, VectorXd& max_acc) {
  ...
  params.x_max_3_13[0] = max_acc(12);
  params.x_max_3_14[0] = max_acc(13);
  params.x_max_3_15[0] = max_acc(14);
  params.x_max_3_16[0] = max_acc(15);
  params.x_max_3_17[0] = max_acc(16);
  params.x_max_3_18[0] = max_acc(17);
  params.x_max_3_19[0] = max_acc(18);
  params.x_max_3_20[0] = max_acc(19);
  params.x_max_3_21[0] = max_acc(20);
  params.x_max_3_22[0] = max_acc(21);
  params.x_max_3_23[0] = max_acc(22);
  params.x_max_3_24[0] = max_acc(23);
  params.x_max_3_25[0] = max_acc(24);
  params.x_max_3_26[0] = max_acc(25);
  params.x_max_3_27[0] = max_acc(26);
  params.x_max_3_28[0] = max_acc(27);
  params.x_max_3_29[0] = max_acc(28);
  params.x_max_3_30[0] = max_acc(29);
  params.x_max_3_31[0] = max_acc(30);
  params.x_max_3_32[0] = max_acc(31);
  params.x_max_3_33[0] = max_acc(32);
  params.x_max_3_34[0] = max_acc(33);
  params.x_max_3_35[0] = max_acc(34);
  params.x_max_3_36[0] = max_acc(35);
  params.x_max_3_37[0] = max_acc(36);
  params.x_max_3_38[0] = max_acc(37);
  params.x_max_3_39[0] = max_acc(38);
  params.x_max_3_40[0] = max_acc(39);
}
