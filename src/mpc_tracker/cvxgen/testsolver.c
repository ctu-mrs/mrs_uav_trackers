/* Produced by CVXGEN, 2018-08-16 08:50:22 -0400.  */
...
void load_default_data(void) {
  ...
  /* Make this a diagonal PSD matrix, even though it's not diagonal. */
  params.R2[0] = 1.2747805054956394;
  ...
  params.Af[5] = -1.6685159248097703;
  params.x_0[0] = 1.8388287490128845;
  params.x_0[1] = 0.16304334474597537;
  params.x_0[2] = 1.3498497306788897;
  params.Bf[0] = -1.3198658230514613;
  params.A[0] = -0.9586197090843394;
  params.A[1] = 0.7679100474913709;
  params.A[2] = 1.5822813125679343;
  params.A[3] = -0.6372460621593619;
  params.A[4] = -1.741307208038867;
  params.A[5] = 1.456478677642575;
  params.B[0] = -0.8365102166820959;
  params.x_max_2[0] = 0.9643296255982503;
  params.x_min_2[0] = -1.367865381194024;
  params.x_max_3[0] = 0.7798537405635035;
  params.x_min_3[0] = 1.3656784761245926;
  params.u_max[0] = 0.9086083149868371;
  params.u_min[0] = -0.5635699005460344;
}
