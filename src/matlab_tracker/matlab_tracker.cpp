...
namespace mrs_trackers
{
  ...
  const mrs_msgs::TrackerConstraintsResponse::ConstPtr MatlabTracker::setConstraints([
...
PLUGINLIB_EXPORT_CLASS(mrs_trackers::MatlabTracker, mrs_uav_manager::Tracker)
