...
colcon test --packages-select mrs_uav_trackers --ctest-args -R 'mpc_tracker_avoidance_two_should_crash' --event-handlers console_direct+ console_stderr- console_start_end-
